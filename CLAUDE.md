...
>
> **Versão atual:** `v1.40.0` · 2026-07-31
>
...
- **Cache busting:** ao mudar `app.js`/`styles.css`, incremente `?v=NNNN` em `index.html` (hoje `app.js?v=1810`, `styles.css?v=1810`) e a constante `APP_VERSION` no topo de `app.js`.
