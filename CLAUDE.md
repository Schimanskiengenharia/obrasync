...
>
> **Versão atual:** `v1.37.0` · 2026-07-27
>
...
- **Cache busting:** ao mudar `app.js`/`styles.css`, incremente `?v=NNNN` em `index.html` (hoje `app.js?v=1801`, `styles.css?v=1801`) e a constante `APP_VERSION` no topo de `app.js`.
